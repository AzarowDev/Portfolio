        ...
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
              ...
              You wish to obtain more information on the projects that we carry out !
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">contact@nas-studio.fr</span>
                </dd>
              </dl>
              <ul role="list" className="mt-8 flex space-x-12">
                <li>
                  <a className="text-indigo-200 hover:text-indigo-100" href="https://github.com/AzarowDev">
                ...
                <li>
                  <a className="text-indigo-200 hover:text-indigo-100" href="https://twitter.com/AzarowDev">
                ...
                <li>
                  <a className="text-indigo-200 hover:text-indigo-100" href="https://www.linkedin.com/in/thibault-pointurier-101201233/">
